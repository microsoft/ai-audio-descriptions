...
- **Resource Group**: `aiad`
- **Microsoft Foundry**: One resource for Content Understanding, GPT, and Speech, including the GPT-5.5 deployment
...
* [Microsoft Foundry](https://learn.microsoft.com/en-us/azure/ai-services/multi-service-resource?pivots=azportal): Create one Foundry resource for Azure Content Understanding, GPT, and Speech. Select a region where GPT-5.5 is available, such as East US 2 or Sweden Central, or another region allowed in `deploy/main.bicep`.
...
* GPT model: In the Foundry resource created above, [deploy a GPT-5.5 model](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/create-resource?pivots=web-portal#deploy-a-model).
...
* `VITE_FOUNDRY_RESOURCE`: The name of the Foundry resource, not the full domain name.
* `VITE_FOUNDRY_KEY`: The key for the Foundry resource.
* `VITE_FOUNDRY_SPEECH_ENDPOINT`: The neural text-to-speech WebSocket endpoint, such as `wss://eastus2.tts.speech.microsoft.com`.
